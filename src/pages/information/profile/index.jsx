                ...
                <div className="row">
                    ...
                    <div className="card">
                        ...
                        <div className="tab-content pt-2">
                            ...
                            <div className="row">
                                <div className="col-lg-3 col-md-4 label">Pendidikan</div>
                                <div className="col-lg-9 col-md-8">
                                Lueilwitz, Wisoky and Leuschke
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-lg-3 col-md-4 label">Pekerjaan</div>
                                <div className="col-lg-9 col-md-8">Web Designer</div>
                            </div>
                            <div className="row">
                                <div className="col-lg-3 col-md-4 label">Negara</div>
                                <div className="col-lg-9 col-md-8">Indonesia</div>
                            </div>
                            <div className="row">
